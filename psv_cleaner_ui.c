...
void initMenuOptions(MenuOptions *menu) {
    ...
    strcpy(menu->options[4], "Crash Dumps");
    strcpy(menu->options[5], "All Categories");
...
void drawOptionsMenu(vita2d_pgf *font, MenuOptions *menu) {
    ...
    // Draw instructions
    vita2d_pgf_draw_text(font, 180, 420, RGBA(200, 200, 200, 255), 0.9f, "Use D-Pad to navigate, X to toggle, O to start cleaning");
}
